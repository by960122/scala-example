...
object GenericDemo {
  def main(args: Array[String]): Unit = {
    val class01 = new EnglishClass[SeasonEnum.seasonEnum, String, String](SeasonEnum.spring, "1班", "高级班")
    println("class01: " + class01.classSesaon + "," + class01.className + "," + class01.classType)

    val class02 = new EnglishClass[SeasonEnum.seasonEnum, Int, Int](SeasonEnum.spring, 2, 1)
